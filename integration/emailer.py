"""
@author Shanthanu Varma
A script to send emails from Python
"""
...
###########
# Configurations
USERNAME = 'my@email.com' # The account from which you'll send the email
PASSWORD = 'mypreciouspassword' # The password
###########
...
class Email:
    ...
    def __init__(self, smtpServer=None):
        ...
        if smtpServer:
            ...
            self._smtpServer = smtplib.SMTP('smtp.gmail.com',587)
...
if __name__ == "__main__":
    # Run some tests
    mFrom = "The Brilliant Mailer <mailbox@somewhere.com>"
    mTo = "recipient@somewhereelse.com"
